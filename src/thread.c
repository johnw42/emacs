...
{
  ENTER_LISP_FRAME ((mutex, name), result);
...
{
  ENTER_LISP_FRAME ((function, name), result);
  sys_thread_t thr;
...
DEFUN ("all-threads", Fall_threads, Sall_threads, 0, 0, 0,
  ...
  (void)
{
  ENTER_LISP_FRAME ((), result, thread);
  result = Qnil;
